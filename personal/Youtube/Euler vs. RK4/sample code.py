...
# To be in the right folder: 
r'''
cd "C:\Users\fhern\OneDrive\Documents\python\personal\Youtube\Euler vs. RK4"
'''
# Copy and Paste this with the right class name 
r'''
& "C:\Program Files\Python311\python.exe" -m manim render "sample code.py" ImplicitSpring -p -ql 
'''
